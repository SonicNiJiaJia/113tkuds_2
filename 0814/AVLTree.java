...
public class AVLTree {
     ...
     * 時間複雜度: O(log n), 空間複雜度: O(log n)
     */
    public AVLVersion insert(int versionId, int data) {
     ...
     * 時間複雜度: O(log n), 空間複雜度: O(log n)
     */
    public AVLVersion delete(int versionId, int data) {
        if (versionId < 0 || versionId >= versions.size()) {
            throw new IllegalArgumentException("Invalid version ID: " + versionId);
        }
    ...
    public static void main(String[] args) {
        ...
        AVLVersion v1 = tree.insert(0, 10);  // 基於版本0插入
        AVLVersion v2 = tree.insert(1, 20);  // 基於版本1插入
        AVLVersion v3 = tree.insert(2, 30);  // 基於版本2插入
        AVLVersion v4 = tree.insert(3, 25);  // 基於版本3插入
        AVLVersion v5 = tree.insert(4, 40);  // 基於版本4插入
        AVLVersion v6 = tree.insert(5, 50);  // 基於版本5插入
        AVLVersion v7 = tree.insert(6, 60);  // 基於版本6插入
        ...
        // 測試刪除操作
        System.out.println("4. 測試刪除操作：");
        AVLVersion v8 = tree.delete(7, 30);  // 從最新版本刪除30
        AVLVersion v9 = tree.delete(8, 20);  // 刪除20
        ...
        AVLVersion branch1 = tree.insert(3, 15);  // 基於版本3創建分支
        AVLVersion branch2 = tree.insert(3, 35);  // 基於版本3創建另一分支
